...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* --- メモ：ランダムメッセージ --- */
  const messages = ['雨上がり、雨水でそうじ', '葛の葉も昼寝するらしい', 'ピュアピュア〜', 'こがねむしスライディング', '洗濯ものがよく乾く日に、寝る', 'かたつむりは前しかすすめない', 'スリッパを洗う', '今朝は緑茶', 'あなたの部屋はごきげんですか', 'みなかみ紀行', 'チリコンコン！', '過去最高のポヤ〜ン', '雨の朝のコーヒー', 'バッタも筋トレする', 'さんぽにいこうか', '風がきもちいい', '雲と目が合ったことありますか', '行き先は風まかせ', '寝るときはいつもひとり', '新陳代謝が上手', 'ニッチニチにニッチ', '電気を消しておふろにはいる'];
